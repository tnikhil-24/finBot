...
def fetch_6_months_4h_data(symbol: str, save: bool = True, delay_seconds: int = 12) -> pd.DataFrame:
    months = get_last_n_months(6)
    all_data = []

    print(f"🔄 Fetching 1-hour data for last 6 months for: {symbol}")
    for month in months:
        ...
        try:
            ...
            # Support both 'timestamp' and 'time'
...
if __name__ == "__main__":
    ...
    df = fetch_6_months_4h_data(symbol, save=True)
    print(df.tail())
